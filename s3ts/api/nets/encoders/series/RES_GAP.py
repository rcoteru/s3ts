...
class RES_GAP_TS(LightningModule):
    ...
    def __init__(self, channels: int, wdw_size: int, ref_size: int,
        ...
        self.res_1 = ResidualBlock_1d(in_channels=self.n_feature_maps, out_channels=self.n_feature_maps)
        self.res_2 = ResidualBlock_1d(in_channels=self.n_feature_maps, out_channels=self.n_feature_maps)
